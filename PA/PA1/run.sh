...
# Config
TESTCASE_DIR="dataset/testcase"
GOLDEN_DIR="dataset/golden"
TARGET="./bin/MPS"
...
log_pass()    { printf "[${GREEN}PASS${RESET}]\n"; }
log_fail()    { printf "[${YELLOW}FAIL${RESET}]\n"; }
...
check_case() {
    ...
    local IN_FILE="$TESTCASE_DIR/${CASE}.in"
    local OUT_FILE="$TESTCASE_DIR/${CASE}.out"
    local GOLD_FILE="$GOLDEN_DIR/${CASE}.out"
